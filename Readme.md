...
- **Continuous Mode**: Supports infinite deposit loops. When enabled, the addon stays active and automatically detects/deposits new items as they appear in your inventory (ideal for Mage Tables).
